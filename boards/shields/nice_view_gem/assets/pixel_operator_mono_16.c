 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font /tmp/pixel_operator/PixelOperatorMono.ttf --size 16 --bpp 1 --no-compress --range 0x20-0x7F --format lvgl -o boards/shields/nice_view_gem/assets/pixel_operator_mono_16.c
 ******************************************************************************/
...
#ifndef PIXEL_OPERATOR_MONO_16
#define PIXEL_OPERATOR_MONO_16 1
#endif

#if PIXEL_OPERATOR_MONO_16
...
static  lv_font_fmt_txt_glyph_cache_t cache_16;
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t pixel_operator_mono_16 = {
#else
lv_font_t pixel_operator_mono_16 = {
#endif
